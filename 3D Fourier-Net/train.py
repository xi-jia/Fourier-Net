...
def train():
    ...
    train_dir = '/bask/projects/d/duanj-ai-imaging/TransMorph_Xi/IXI_Mine/IXI_data/Train/'
    val_dir = '/bask/projects/d/duanj-ai-imaging/TransMorph_Xi/IXI_Mine/IXI_data/Val/'
