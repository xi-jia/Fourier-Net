...
def main():
    ...
    atlas_dir = '/home/xij/FlashRelated/IXI_data/atlas.pkl'
    test_dir = '/home/xij/FlashRelated/IXI_data/Test/'
    model_idx = -1
    ...
    # print('Best model: {}'.format(natsorted(os.listdir(model_dir))[model_idx]))#['state_dict']
